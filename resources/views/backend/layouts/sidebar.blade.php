<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main" style="z-index: 999;">
	<div class="sidenav-header">
		...
		<a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
			<img src="{{ asset('frontend') }}/img/logotema.png" class="navbar-brand-img h-100" alt="main_logo">
	...
	<div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: auto;">
		<ul class="navbar-nav">
			<!-- <li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('articles.index') ? 'show active' : '' }}" href="{{ route('backend.dashboard') }}">
			...
			<li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('articles.index') ? 'show active' : '' }}" href="{{ route('articles.index') }}">
					<div class="w-15 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('article-categories.index') ? 'show active' : '' }}" href="{{ route('article-categories.index') }}">
					<div class="w-15 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('office-profiles.index') ? 'show active' : '' }}" href="{{ route('office-profiles.index') }}">
					<div class="w-15 d-flex align-items-center justify-content-center">
						<i class="fa fa-bookmark-o text-info opacity-10"></i>
					</div>
			...
			<li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('topmenu.index') ? 'show active' : '' }}" href="{{ route('topmenu.index') }}">
					<div class="w-15 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item p-2">
				<a class="nav-link gap-3 {{ request()->routeIs('setting-slider.index') ? 'show active' : '' }}" href="{{ route('setting-slider.index') }}">
					<div class="w-15 d-flex align-items-center justify-content-center">
