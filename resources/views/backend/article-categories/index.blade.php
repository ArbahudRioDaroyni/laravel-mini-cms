...
@section('content')
		...
		<div class="col-12">
			...
			<div class="card mb-4">
				...
				<div class="card-body p-4 pt-2">
					<button onclick="modalCreate(`{{ route('article-categories.store') }}`)" type="button" class="btn bg-gradient-success mb-3" data-bs-toggle="modal" data-bs-target="#modal-form">Tambah baru</button>
	...
	@includeIf('backend.article-categories.modal-form')
@endsection

@push('scripts')
<script>
	let table = new DataTable('#table', {
		ajax: '{{ route('article-categories.api') }}',
		stateSave: true,
		processing: true,
		autoWidth: false,
		serverSide: true,
